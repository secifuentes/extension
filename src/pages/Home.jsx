...
<div className="w-full h-[calc(100vh-54px)] relative overflow-hidden">
  ...
  <div className="transition-opacity duration-700 ease-in-out w-full">
    {imagenActual === 0 ? (
      // Slide 1: solo botón, más abajo
      <div className="w-full flex justify-center mt-20">
        <a
          href="#cursos"
          className="px-6 py-2 border-2 border-white text-white font-semibold rounded-md animate-slide-up backdrop-blur-sm bg-white/10 hover:bg-white/20 transition"
        >
